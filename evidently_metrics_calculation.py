...
def calculate_metrics_postgresql(curr, i):
	...
	quantile_value = result['metrics'][1]['result']["current"]["value"]
	...
	curr.execute(
		"insert into dummy_metrics(timestamp, prediction_drift, quantile_value, num_drifted_columns, share_missing_values) values (%s, %s, %s, %s, %s)",
		(begin + datetime.timedelta(i), prediction_drift, quantile_value, num_drifted_columns, share_missing_values)
	)
